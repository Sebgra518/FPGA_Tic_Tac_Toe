...
HD_PWD='E:/Github/FPGA_Tic_Tac_Toe/FPGA_Tic_Tac_Toe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToeTopAN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TicTacToeTopAN.tcl -notrace
