...
HD_PWD='E:/Github/FPGA_Tic_Tac_Toe/FPGA_Tic_Tac_Toe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToeTopAN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TicTacToeTopAN.tcl
